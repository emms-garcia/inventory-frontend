  ...
  return function (options) {
    ...
    if(options.key === 'es-mx') {
      translations = {
        ...
        BULK_ACTIONS: 'Acciones en Seleccionados',
        ADD_NEW_PRODUCT: 'Agregar Nuevo Producto',
        VIEW_MORE: 'Ver Más',
        NO_MORE_DATA: 'No hay más datos',
        ADD_NEW_UOM: 'Agregar Nueva Unidad de Medida',
        DELETE_UOMS_MODAL_BODY: 'Estás seguro que deseas borrar estas unidades de medida?',
        DELETE_UOMS_MODAL_TITLE: 'Borrar Unidades de Medida',
        ADD_NEW_CLIENT: 'Agregar Nuevo Cliente',
        DELETE_CLIENTS_MODAL_BODY: 'Estás seguro que deseas borrar estos clientes?',
        ...
        TRANSACTION_INFORMATION: 'Información Básica',
        TRANSACTION_NAME: 'Nombre',
        TRANSACTION_DESCRIPTION: 'Descripción',
        TRANSACTION_CART: 'Productos',
        TRANSACTION_BILLING: 'Datos de Facturación',
        TRANSACTION_PREVIEW: 'Confirmación',
        TOTALS: 'Totales',
        COMMENT: 'Comentario',
        BILLING: 'Facturación',
        EDIT: 'Editar',
        CREATE_AND_EXIT: 'Crear y Salir',
        CREATE_AND_ADD_NEW: 'Crear y Agregar Nuevo',
        SALE_SUMMARY: 'Resumen de Venta',
        PURCHASE_SUMMARY: 'Resumen de Compra',
        TRANSACTION_LOCATION: 'Lugar de Emisión',
        TRANSACTION_DATE: 'Fecha de Emisión',
        TRANSACTION_TIME: 'Hora de Emisión',
        TRANSACTION_INGRESS: 'Ingreso',
        TRANSACTION_EXIT: 'Egreso',
        TRANSACTION_EFFECT: 'Efecto de la transacción',
        ISSUER_RFC: 'RFC del Emisor',
        ISSUER_BILLING_ADDRESS: 'Domicilio Fiscal del Emisor',
      ...
      translations = {
        ...
        RECEPTOR_RFC: 'Receptor\'s RFC',
        RECEPTOR_BILLING_ADDRESS: 'Receptor\'s Address',
        TRANSACTION_EFFECT: 'Transaction Effect',
        TRANSACTION_INGRESS: 'Ingress',
        TRANSACTION_EXIT: 'Exit',
        TRANSACTION_TIME: 'Transaction Time',
        TRANSACTION_DATE: 'Transaction Date',
        TRANSACTION_LOCATION: 'Transaction Location',
        SALE_SUMMARY: 'Sale Summary',
        PURCHASE_SUMMARY: 'Purchase Sumamry',
        CREATE_AND_EXIT: 'Crate and Exit',
        CREATE_AND_ADD_NEW: 'Create and Add New',
        EDIT: 'Edit',
        BILLING: 'Billing',
        COMMENT: 'Comment',
        TOTALS: 'Totals',
        TRANSACTION_INFORMATION: 'Basic Information',
        TRANSACTION_NAME: 'Name',
        TRANSACTION_DESCRIPTION: 'Description',
        TRANSACTION_CART: 'Products',
        TRANSACTION_BILLING: 'Billing Info',
        TRANSACTION_PREVIEW: 'Confirmation',
        ...
        DELETE_CLIENTS_MODAL_TITLE: 'Delete Clients',
        ADD_NEW_CLIENT: 'Add New Client',
        DELETE_UOMS_MODAL_BODY: 'Are you sure you want to delete these units of measure?',
        DELETE_UOMS_MODAL_TITLE: 'Delete Units of Measure',
